    ...
    constructor(props) {
        ...
        this.setEventhandlers = (cy) => {
            ...
            cy.on('tap', 'node', function (evt) {
                const selectedNodeId = evt.target.id();
                const selectedNodeName = evt.target.data("name");
        ...
        return (React.createElement("div", { style: { width: "500px", height: "500px" } },
            ...
            React.createElement("div", { style: { width: '200px', height: '300px', position: 'absolute', right: 0, top: 0 } },
                ...
                React.createElement("div", { style: { width: "100px", height: "50px" } },
                    ...
                    React.createElement(annote_1.default, { selectedNodeId: this.state.selectedNodeId, selectedNodeName: this.state.selectedNodeName, nodes: elements.nodes.length, edges: elements.edges.length })))));
    }
}
